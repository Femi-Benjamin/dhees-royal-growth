        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-grow container mx-auto px-4 py-8">
                <div className="max-w-2xl mx-auto">
                    <h1 className="font-display text-3xl md:text-4xl font-bold mb-4 text-center">Book Your Appointment</h1>
                    <p className="text-muted-foreground text-center mb-8">Fill out the form below to schedule your visit or virtual consultation.</p>
